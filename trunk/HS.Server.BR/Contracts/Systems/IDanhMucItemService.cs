...
namespace HS.Server.BR.Contracts.Systems
{
    /// <summary>
    /// IDanhMucItemService interface for service layer mapped table DanhMuc_Item.
    /// CODE:
    ///     - Author:    BangDV
    ///     - Generated Date:  20/07/2013 04:17:36 PM
    /// </summary>
    [ServiceContract]
    public interface IDanhMucItemService
    {
        ...
        /// <returns></returns>
        [OperationContract]
        DanhMucItemData GetDanhMucItemByID(System.String maLoaiDanhMuc, System.String MaDanhMuc);
