...
@"
        ...
        {{
            ...
            {{
                Utils.Logger.Log(""[Add{0}] : "" + ex.Message);
            }}
            return -1;
        }}

        public System.Int32 ChangeDealContract({0}Data data)
        {{
            try
            {{
                var domain = new {0}DomainObject(ConnectionString);
            ...
            {{
                Utils.Logger.Log(""[Change{0}] : "" + ex.Message);
            }}
            return -1;
        }}
        ...
        {{
            ...
            {{
                Utils.Logger.Log(""[Remove{0}] : "" + ex.Message);
            }}
            return -1;
        }}
        ...
        {{
            ...
            {{
                Utils.Logger.Log(""[Get{0}s] : "" + ex.Message);
                return null;
            }}
        }}
        ...
        {{
            ...
            {{
                Utils.Logger.Log(""[Get{0}ByID] : "" + ex.Message);
                return null;
            }}
        }}
        ...
        {{
            ...
            {{
                Utils.Logger.Log(""[Get{0}ByCriteria] : "" + ex.Message);
                return null;
            }}
        }}
        ...
        {{
            ...
            {{
                Utils.Logger.Log(""[Get{0}BySizeCriteria] : "" + ex.Message);
                return null;
            }}
        }}
        ...
        {{
            ...
            {{
                Utils.Logger.Log(""[Get{0}Count] : "" + ex.Message);
            }}
            return -1;
        }}
        ...
        {{
            ...
            {{
                Utils.Logger.Log(""[Get{0}Paging] : "" + ex.Message);
